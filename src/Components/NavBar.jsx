...
import Mic from '../Assets/Images/Mic';
    ...
    <nav>
      <ul className="nav-list">
        <li>
          {' '}
          <Link to="/">
            <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 24 24" width="512" height="512" fill="white" className="home-icon">
